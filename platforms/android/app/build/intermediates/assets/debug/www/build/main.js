...
var TabsPage = /** @class */ (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/ivael/Documentos/ionic/Forestal/src/pages/tabs/tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" ></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"/home/ivael/Documentos/ionic/Forestal/src/pages/tabs/tabs.html"*/
        }),
    ...
    AboutPage.prototype.sincronizar = function () {
        ...
        this._login.getRequerimientos(this._login.cuit)
            ...
            if (_this.requerimientos) {
                _this._login.getEspecies()
                    .subscribe(function (resp) {
                    _this.especies = resp;
                    console.log(_this.especies);
                    localStorage.setItem('especies', JSON.stringify(_this.especies));
                });
                if (_this.especies) {
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/ivael/Documentos/ionic/Forestal/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/home/ivael/Documentos/ionic/Forestal/src/app/app.html"*/
        }),
